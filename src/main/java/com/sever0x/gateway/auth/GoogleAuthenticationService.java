package com.sever0x.gateway.auth;

import com.google.api.client.googleapis.auth.oauth2.GoogleIdToken;
import com.google.api.client.googleapis.auth.oauth2.GoogleIdTokenVerifier;
import com.google.api.client.http.javanet.NetHttpTransport;
import com.google.api.client.json.gson.GsonFactory;
import com.sever0x.gateway.auth.dto.GoogleOauthTokenRequest;
import com.sever0x.gateway.auth.dto.GoogleOauthTokenResponse;
...
public class GoogleAuthenticationService {
    ...
    public Mono<UserInfo> processAuthenticationCallback(String code, String redirectUri) {
        return requestOauthTokens(code, redirectUri)
                ...
                .map(googleIdToken -> UserInfo.builder()
